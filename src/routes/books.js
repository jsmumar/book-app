...
router.get("/search", (req, res) => {
    request
        .get(
            `https://www.goodreads.com/search/index.xml?key=otf7Tm6JmQ6EYgcEwdNj6Q&q=${req.query.q}`
        )
        .then(result => 
...
router.get("/fetchPages", (req, res) => {
    ...
    request
        .get(
            `https://www.goodreads.com/book/show.xml?key=otf7Tm6JmQ6EYgcEwdNj6Q&id=${goodreadsId}`
        )
        .then(result => 
            parseString(result, (err, goodreadsResult) => {
